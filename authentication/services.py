...
class TwoFactorService:
    ...
    def generate_and_send_code(self, user, method):
        ...
        # Don't generate TOTP codes server-side, they should come from the authenticator app
        if method == "totp":
            return False, "TOTP codes should be generated by your authenticator app"
        ...
        if method == "email":
            ...
            # In a real app: send_sms(user.twofactorauth.phone_number, f"Your verification code is: {code}")
            message = f"Code sent to {user.twofactorauth.phone_number}"
        elif method == "call":
            print(f"Calling {user.twofactorauth.phone_number} with code {code}")
            # In a real app: make_call(user.twofactorauth.phone_number, code)
            message = f"Calling {user.twofactorauth.phone_number}"
        else:
